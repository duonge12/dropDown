...
export const RangePicker=({
    ...
    const [value,setValue]=useState('Put your value')
      ...
      <div className={className}>
        ...
        <div className={`${visible? `` :`hidden`} py-3 w-full border-2 border-black rounded-md justify-around`}>
            <div className="mx-5 y5 border-2 border-black rounded-xl flex justify-around">
                <input 
                    type="number" 
                    className="py-2 text-center w-2/5 outline-none rounded-xl" 
                    value={start}
                    onChange={handleStartChange}/>
                <span>|</span>
                <input 
                    type="number" 
                    className=" text-center w-2/5 outline-none rounded-xl" 
                    value={end}
                    onChange={handleEndChange}/>
            </div>
            <div className="mx-5 mt-2 flex justify-around">
                <Button className="px-4 py-1 rounded-xl"  onClick={handleDrop} colorTheme={ETheme.PRIMARY_DARK}>Apply</Button>
